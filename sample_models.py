...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    rnn1 = GRU(units, activation='relu', return_sequences=True, implementation=2)(input_data)
...
def final_model(input_dim, filters=200, kernel_size=11, conv_stride=2, conv_border_mode='valid', units = 200, recur_layers = 2, dropout_rate=0, activation = 'relu', cell=GRU, bidirection = True, output_dim=29):
    ...
    for i in range(recur_layers):
        if bidirection:
            rnn = Bidirectional(cell(units, activation=activation, return_sequences=True, implementation=2, dropout=dropout_rate), merge_mode='concat')(bn)
        else:
            rnn = cell(units, activation=activation, return_sequences=True, implementation=2, dropout=dropout_rate)(bn)
